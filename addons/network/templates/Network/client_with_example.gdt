...
##
# Example function for receiving a packet from the server.
#
# Format requires receive_[PacketName](params passed from server) -> bool
#
...
##
func receive_response(message: String) -> bool:
	print(message)
	return true # successfully received

##
# Example function for sending a packet to the server.
#
...
func send_message(message: String) -> void:
	...
	socket_send(Packet.Client.message, [message])
